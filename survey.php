...
<head>
    ...
    <title>Survey | Advanced Dental of Monroe </title>
     <meta name="description" content="Share your feedback with Advanced Dental of Monroe, Monroe Township, NJ, help us improve patient care and services by completing our quick, confidential survey today." />
...
<body id="survey_page" class="logo-manage">
            ...
            <div class="row align-items-center">
                <div class="col-md-6 col-sm-6 col-7 default-padding">
                    <div class="header_logo">
                        <img src="/lp-asset/lp-images/logo.svg" alt="Advanced Dental of Monroe" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php
    $teatment_type = isset($_REQUEST['treatment']) || !empty($_REQUEST['treatment']) ? $_REQUEST['treatment'] : '';
    $p = isset($_REQUEST['p']) || !empty($_REQUEST['p']) ? $_REQUEST['p'] : '';
    $how_soon = isset($_REQUEST['how_soon']) || !empty($_REQUEST['how_soon']) ? $_REQUEST['how_soon'] : '';
    $fname = isset($_REQUEST['fname']) || !empty($_REQUEST['fname']) ? $_REQUEST['fname'] : '';
    $lname = isset($_REQUEST['lname']) || !empty($_REQUEST['lname']) ? $_REQUEST['lname'] : '';
    ?>
    <!-- /*----treatment--*/  -->
    <div class="location-page treatment-page" id="step1">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-content text-center">
                                <h1>What Dental Treatment Are You Looking For ?</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="table">
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="form-content text-center">
                                <h2>What is your contact info?</h2>
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <div class="email-content">
                                            <label>
                                                ...
                                                <input type="hidden" name="tag_name2" id="tag_name2" value="lp">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-sm-10 col-12">
                            ...
                            <div class="disclaimer-msg">
                                <p><a href="/privacy-policy" target="_blank">Privacy Policy</a> | <a href="/terms-condition" target="_blank">Terms of Service</a></p>
    ...
    <script>
        ...
        document.addEventListener('readystatechange', event => {
            if (event.target.readyState === "complete") {
                ...
                jQuery('input:radio[name="treatment_type"]').prop('checked',false);
            }
        });
        var url = window.location.href;
        if (url.indexOf("step1") != -1) {
            var treatment = '<?= $teatment_type ?>';
            var page = '<?= $p ?>';
        ...
        jQuery('#cretivego8').click(function () {
            // Validate all fields independently so every error shows at once
            var hasError = false;
            ...
            if (jQuery('#last_name').val() == '') {
                ...
                jQuery('.lbl_last_name').hide();
            }

            if (jQuery('#phone').val() == '') {
                jQuery('.lbl_phone').show();
                jQuery('.lbl_phone_pattern').hide();
                hasError = true;
            } else {
                jQuery('.lbl_phone').hide();
            ...
            if (jQuery('#email').val() == '') {
                ...
                jQuery('.lbl_email_pattern').hide();
                hasError = true;
            } else {
                jQuery('.lbl_email_address').hide();
            ...
            // All valid — build and submit payload
            ...
            const customFields = {
                'xZp1w8ibqzE4WsroZBzy': $('#treatment_type').val(),
                'UkuDZp2gTLOoBt9R25ts': $('#how_soon').val(),
                'Ptur6ll6Bo1tClxlfELh': $('#is_ready_to_book').val(),
                'jeOy2NUIMjXemlN5vM5u': $('#dental_anxiety').val(),
                'erbS03Ibo6FoYwFF5PHu': $('#i_agree').val(),
                'p7ky6RBp7ApaZkt4K54A': $('#i_agree_marketing_messages').val()
            };
            const customFieldsArray = Object.entries(customFields).map(([id, value]) => ({ id, value }));
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#cretivego8').prop('disabled', true).html('Processing <i class="fa fa-spinner fa-spin"></i>');
                },
                success: function(data) {
                    ...
                    var message = (data.message) ? data.message : 'Thank you! Your submission has been received.';
                    toastr.success(message);
                    window.location.href = '/thank-you.html';
                },
                error: function(err) {
                    console.error(err);
                    $('#cretivego8').prop('disabled', false).html('Book your appointment today');
